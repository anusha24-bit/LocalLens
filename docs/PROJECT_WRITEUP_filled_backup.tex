...
\begin{figure}[H]
\centering
\IfFileExists{figures/source_pipeline_overview.png}{
    \includegraphics[width=0.9\textwidth]{figures/source_pipeline_overview.png}
}{
    \fbox{\parbox{0.88\textwidth}{
    \centering
    Add visual here: architecture / system pipeline figure.\\
...
\begin{figure}[H]
\centering
\IfFileExists{figures/source_breakdown.png}{
    \includegraphics[width=0.78\textwidth]{figures/source_breakdown.png}
}{
    \fbox{\parbox{0.8\textwidth}{
    \centering
    Add plot here: bar chart of source-document counts by source type.\\
...
\begin{figure}[H]
\centering
\IfFileExists{figures/place_category_distribution.png}{
    \includegraphics[width=0.82\textwidth]{figures/place_category_distribution.png}
}{
    \fbox{\parbox{0.84\textwidth}{
    \centering
    Add plot here: top place-category distribution in the corpus.\\
...
\begin{figure}[H]
\centering
\IfFileExists{figures/app_main_ui.png}{
    \includegraphics[width=0.95\textwidth]{figures/app_main_ui.png}
}{
    \fbox{\parbox{0.92\textwidth}{
    \centering
    Add screenshot here: main Streamlit interface showing the query box, answer, retrieval notes, and citations.\\
...
\begin{figure}[H]
\centering
\IfFileExists{figures/eval_query_examples.png}{
    \includegraphics[width=0.95\textwidth]{figures/eval_query_examples.png}
}{
    \fbox{\parbox{0.92\textwidth}{
    \centering
    Add screenshot montage here: two or three representative query outputs, ideally one strong answer and one honest abstention.\\
...
\begin{figure}[H]
\centering
\IfFileExists{figures/query_family_summary.png}{
    \includegraphics[width=0.85\textwidth]{figures/query_family_summary.png}
}{
    \fbox{\parbox{0.86\textwidth}{
    \centering
    Add plot here: a simple summary chart of query families (strong / partial / weak).\\
